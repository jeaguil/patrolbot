...
# function to show video based on URL
def showVideo(url):
...
if __name__ == '__main__':
    # retrieve the Kinesis stream URL based on AWS credentials
    #url = hls_stream()
    # stream url when on the same network (not hamachi)
    url = 'rtsp://10.1.14.26:8080/'
    # show video stream based on URL
    #showVideo(url)
